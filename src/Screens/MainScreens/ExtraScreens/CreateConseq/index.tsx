  ...
  return (
    <SafeAreaView
      ...
      <View style={{marginHorizontal: 15, flex: 1}}>
        ...
        <TouchableOpacity
          onPress={() =>
            setloser_task(`Winner directs a TikTok for the loser to perform.`)
          }
          style={{
            height: 90,
            borderWidth: 5,
          ...
          <View style={{width: '80%'}}>
            <Text>Winner directs a TikTok for the loser to perform.</Text>
          </View>
          <View>
            <Image
              resizeMode="contain"
        ...
        <TouchableOpacity
          ...
          <View style={{width: '80%'}}>
            <Text>Donate $5 to charity of winner's choice.</Text>
          </View>
          <View>
            <Image
              resizeMode="contain"
